...
const WoodChipsPage: React.FC = () => {
  const woodChips = fuels.find(fuel => fuel.id === 'wood-chips')!;

  const faqData = {
    rows: woodChips.faqs.map(faq => ({
      title: faq.question,
      content: faq.answer
    }))
  };
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center">
            ...
            >
              ...
              <motion.div 
                ...
                viewport={{ once: true }}
              >
                {woodChips.advantages.map((advantage, index) => (
                  <motion.div 
                    key={index} 
      ...
      >
        <div className="container-custom">
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            {woodChips.applications.map((application, index) => (
              <motion.div 
                key={index} 
          ...
          >
            <div className="bg-white rounded-2xl shadow-xl p-4 sm:p-6 lg:p-8 hover:shadow-2xl transition-all duration-500 border border-gray-100">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
                ...
                >
                  <h3 className="font-bold text-lg sm:text-xl md:text-2xl text-primary-800 mb-2">Calorific Value</h3>
                  <p className="text-xl sm:text-2xl md:text-3xl font-bold text-primary-600">{woodChips.calorificValue} kcal/kg</p>
                </motion.div>
                <motion.div
                  whileHover={{ scale: 1.05 }}
                  transition={{ type: "spring", stiffness: 300 }}
                ...
                >
                  <h3 className="font-bold text-lg sm:text-xl md:text-2xl text-accent-800 mb-2">Type</h3>
                  <p className="text-sm sm:text-base md:text-lg lg:text-xl font-semibold text-accent-600">{woodChips.type}</p>
                </motion.div>
              </div>
            </div>
          </motion.div>
        ...
        <div className="container-custom relative z-10">
          ...
          >
            ...
            <motion.p 
              ...
              variants={itemVariants}
            >
              Contact us to learn more about our wood chips solutions and get a customized quote for your needs.
            </motion.p>
            <motion.div
              variants={itemVariants}
              whileHover={{ scale: 1.05 }}
