            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 hover:shadow-2xl transition-all duration-500 border border-gray-100">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                >
                  ...
                  <p className="text-3xl font-bold text-primary-600">{pellets.calorificValue} kcal/kg</p>
                </motion.div>
                <motion.div
                  whileHover={{ scale: 1.05 }}
                  transition={{ type: "spring", stiffness: 300 }}
                ...
                >
                  ...
                  <p className="text-xl font-semibold text-accent-600">{pellets.type}</p>
                </motion.div>
              </div>
            </div>
          </motion.div>
        ...
        <div className="container-custom relative z-10">
          ...
          >
            ...
            <motion.p 
              ...
              variants={itemVariants}
            >
              Contact us to learn more about our wood pellet solutions and get a customized quote for your needs.
            </motion.p>
            <motion.div
              variants={itemVariants}
              whileHover={{ scale: 1.05 }}
