            ...
            <div className="bg-white rounded-2xl shadow-xl p-4 sm:p-6 lg:p-8 hover:shadow-2xl transition-all duration-500 border border-gray-100">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
                ...
                >
                  ...
                  <p className="text-xl sm:text-2xl md:text-3xl font-bold text-primary-600">{briquettes.calorificValue} kcal/kg</p>
                </motion.div>
                <motion.div
                  whileHover={{ scale: 1.05 }}
                  transition={{ type: "spring", stiffness: 300 }}
                ...
                >
                  ...
                  <p className="text-sm sm:text-base md:text-lg lg:text-xl font-semibold text-accent-600">{briquettes.type}</p>
                </motion.div>
              </div>
            </div>
          </motion.div>
        ...
        <div className="container-custom relative z-10">
          ...
          >
            ...
            <motion.p 
              ...
              variants={itemVariants}
            >
              Contact us to learn more about our biomass briquette solutions and get a customized quote for your needs.
            </motion.p>
            <motion.div
              variants={itemVariants}
              whileHover={{ scale: 1.05 }}
