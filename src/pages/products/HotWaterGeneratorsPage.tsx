            ...
            {[
              {
                ...
                description: "Ideal for manufacturing and processing facilities requiring reliable hot water supply."
              },
              {
                title: "Commercial Buildings",
                description: "Perfect for hotels, hospitals, and large commercial complexes with high hot water demand."
              },
              {
                title: "District Heating",
                description: "Suitable for centralized heating systems and district networks requiring consistent hot water."
              }
