            ...
            {[
              {
                ...
                description: "Perfect for drying agricultural products, timber, and industrial materials with precise temperature control."
              },
              {
                title: "Space Heating",
                description: "Efficient heating solution for large industrial and commercial spaces requiring consistent warmth."
              },
              {
                title: "Process Heating",
                description: "Ideal for manufacturing processes requiring controlled hot air flow and temperature management."
              }
