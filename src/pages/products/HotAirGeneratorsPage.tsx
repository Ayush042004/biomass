...
const HotAirGeneratorsPage: React.FC = () => {
  const hotAirGenerator = products.find(product => product.id === 'hot-air-generators')!;

  const faqData = {
    rows: hotAirGenerator.faqs.map(faq => ({
      title: faq.question,
      content: faq.answer
    }))
  };
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center">
            ...
            >
              <div className="relative group">
                ...
                <img 
                  src={hotAirGenerator.image}
                  alt={hotAirGenerator.title}
            ...
            >
              ...
              <motion.div 
                ...
                viewport={{ once: true }}
              >
                {hotAirGenerator.details?.map((detail, index) => (
                  <motion.div 
                    key={index} 
            ...
            {[
              {
                ...
                description: "Perfect for industrial drying applications requiring controlled hot air flow."
              },
              {
                title: "Space Heating",
                description: "Ideal for large spaces requiring efficient and consistent heating solutions."
              },
              {
                title: "Food Processing",
                description: "Essential for food manufacturing requiring precise temperature control."
              }
          ...
          >
            <div className="bg-white rounded-2xl shadow-xl p-4 sm:p-6 lg:p-8 hover:shadow-2xl transition-all duration-500 border border-gray-100">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
                ...
                >
                  <h3 className="font-bold text-lg sm:text-xl md:text-2xl text-primary-800 mb-2">Air Temperature</h3>
                  <p className="text-xl sm:text-2xl md:text-3xl font-bold text-primary-600">Up to 200°C</p>
                </motion.div>
                <motion.div
                  whileHover={{ scale: 1.05 }}
                  transition={{ type: "spring", stiffness: 300 }}
                ...
                >
                  <h3 className="font-bold text-lg sm:text-xl md:text-2xl text-accent-800 mb-2">Air Flow Rate</h3>
                  <p className="text-sm sm:text-base md:text-lg lg:text-xl font-semibold text-accent-600">Up to 5000 CFM</p>
                </motion.div>
              </div>
            </div>
          </motion.div>
