...
const SteamBoilersPage: React.FC = () => {
  const steamBoiler = products.find(product => product.id === 'steam-boilers')!;

  const faqData = {
    rows: steamBoiler.faqs.map(faq => ({
      title: faq.question,
      content: faq.answer
    }))
  };
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center">
            ...
            >
              <div className="relative group">
                ...
                <img 
                  src={steamBoiler.image}
                  alt={steamBoiler.title}
            ...
            >
              ...
              <motion.div 
                ...
                viewport={{ once: true }}
              >
                {steamBoiler.details?.map((detail, index) => (
                  <motion.div 
                    key={index} 
            ...
            {[
              {
                ...
                description: "Perfect for manufacturing facilities requiring reliable steam generation for various processes."
              },
              {
                title: "Food & Beverage",
                description: "Ideal for cooking, sterilization, and cleaning processes in food production facilities."
              },
              {
                title: "Textile Industry",
                description: "Essential for dyeing, finishing, and pressing operations in textile manufacturing."
              }
            ...
            <div className="bg-white rounded-2xl shadow-xl p-4 sm:p-6 lg:p-8 hover:shadow-2xl transition-all duration-500 border border-gray-100">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
                ...
                >
                  ...
                  <p className="text-xl sm:text-2xl md:text-3xl font-bold text-primary-600">Up to 10 TPH</p>
                </motion.div>
                <motion.div
                  whileHover={{ scale: 1.05 }}
                  transition={{ type: "spring", stiffness: 300 }}
                ...
                >
                  ...
                  <p className="text-sm sm:text-base md:text-lg lg:text-xl font-semibold text-accent-600">Up to 25 bar</p>
                </motion.div>
              </div>
            </div>
          </motion.div>
