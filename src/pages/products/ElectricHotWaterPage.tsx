...
const ElectricHotWaterPage: React.FC = () => {
  const electricHotWater = products.find(product => product.id === 'electric-hot-water')!;

  const faqData = {
    rows: electricHotWater.faqs.map(faq => ({
      title: faq.question,
      content: faq.answer
    }))
  };
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center">
            ...
            >
              <div className="relative group">
                ...
                <img 
                  src={electricHotWater.image}
                  alt={electricHotWater.title}
            ...
            >
              ...
              <motion.div 
                ...
                viewport={{ once: true }}
              >
                {electricHotWater.details?.map((detail, index) => (
                  <motion.div 
                    key={index} 
