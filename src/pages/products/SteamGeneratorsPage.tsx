...
const SteamGeneratorsPage: React.FC = () => {
  const steamGenerator = products.find(product => product.id === 'steam-generators')!;

  const faqData = {
    rows: steamGenerator.faqs.map(faq => ({
      title: faq.question,
      content: faq.answer
    }))
  };
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center">
            ...
            >
              <div className="relative group">
                ...
                <img 
                  src={steamGenerator.image}
                  alt={steamGenerator.title}
            ...
            >
              ...
              <motion.div 
                ...
                viewport={{ once: true }}
              >
                {steamGenerator.details?.map((detail, index) => (
                  <motion.div 
                    key={index} 
            ...
            {[
              {
                ...
                description: "Perfect for power plants requiring high-pressure steam for electricity generation."
              },
              {
                title: "Industrial Processing",
                description: "Ideal for manufacturing facilities requiring steam for various industrial processes."
              },
              {
                title: "District Heating",
                description: "Essential for centralized heating systems and district networks."
              }
          ...
          >
            <div className="bg-white rounded-2xl shadow-xl p-4 sm:p-6 lg:p-8 hover:shadow-2xl transition-all duration-500 border border-gray-100">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
                ...
                >
                  <h3 className="font-bold text-lg sm:text-xl md:text-2xl text-primary-800 mb-2">Steam Capacity</h3>
                  <p className="text-xl sm:text-2xl md:text-3xl font-bold text-primary-600">Up to 50 TPH</p>
                </motion.div>
                <motion.div
                  whileHover={{ scale: 1.05 }}
                  transition={{ type: "spring", stiffness: 300 }}
                ...
                >
                  <h3 className="font-bold text-lg sm:text-xl md:text-2xl text-accent-800 mb-2">Pressure Range</h3>
                  <p className="text-sm sm:text-base md:text-lg lg:text-xl font-semibold text-accent-600">Up to 100 bar</p>
                </motion.div>
              </div>
            </div>
          </motion.div>
