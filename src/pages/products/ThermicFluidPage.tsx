            ...
            {[
              {
                ...
                description: "Ideal for reaction vessels and distillation processes requiring precise temperature control."
              },
              {
                title: "Pharmaceutical",
                description: "Perfect for precise temperature control in drug manufacturing and pharmaceutical processes."
              },
              {
                title: "Food Processing",
                description: "Suitable for cooking, drying, and sterilization processes in food production facilities."
              }
