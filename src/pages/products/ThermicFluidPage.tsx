...
const ThermicFluidPage: React.FC = () => {
  const thermicFluid = products.find(product => product.id === 'thermic-fluid')!;

  const faqData = {
    rows: thermicFluid.faqs.map(faq => ({
      title: faq.question,
      content: faq.answer
    }))
  };
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center">
            ...
            >
              <div className="relative group">
                ...
                <img 
                  src={thermicFluid.image}
                  alt={thermicFluid.title}
            ...
            >
              ...
              <motion.div 
                ...
                viewport={{ once: true }}
              >
                {thermicFluid.details?.map((detail, index) => (
                  <motion.div 
                    key={index} 
            ...
            {[
              {
                ...
                description: "Perfect for chemical plants requiring precise temperature control for reactions."
              },
              {
                title: "Oil & Gas",
                description: "Ideal for refineries and petrochemical facilities requiring high-temperature heat transfer."
              },
              {
                title: "Food Processing",
                description: "Essential for food manufacturing requiring consistent high-temperature processing."
              }
          ...
          >
            <div className="bg-white rounded-2xl shadow-xl p-4 sm:p-6 lg:p-8 hover:shadow-2xl transition-all duration-500 border border-gray-100">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
                ...
                >
                  <h3 className="font-bold text-lg sm:text-xl md:text-2xl text-primary-800 mb-2">Temperature Range</h3>
                  <p className="text-xl sm:text-2xl md:text-3xl font-bold text-primary-600">Up to 400°C</p>
                </motion.div>
                <motion.div
                  whileHover={{ scale: 1.05 }}
                  transition={{ type: "spring", stiffness: 300 }}
                ...
                >
                  <h3 className="font-bold text-lg sm:text-xl md:text-2xl text-accent-800 mb-2">Flow Rate</h3>
                  <p className="text-sm sm:text-base md:text-lg lg:text-xl font-semibold text-accent-600">Up to 500 LPM</p>
                </motion.div>
              </div>
            </div>
          </motion.div>
        ...
        <div className="container-custom relative z-10">
          ...
          >
            ...
            <motion.p 
              ...
              variants={itemVariants}
            >
              Contact us to learn more about our thermic fluid solutions and get a customized quote for your needs.
            </motion.p>
            <motion.div
              variants={itemVariants}
              whileHover={{ scale: 1.05 }}
