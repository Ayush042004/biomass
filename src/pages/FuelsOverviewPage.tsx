                ...
                >
                  <div className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden h-full">
                    ...
                    <div className="p-8">
                      ...
                      <p className="text-gray-600 mb-4 leading-relaxed">{fuel.description}</p>
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <motion.h2 
              ...
              variants={itemVariants}
            >
              Ready to Switch to Sustainable Fuels?
            </motion.h2>
            <motion.p 
              className="text-xl mb-8 max-w-3xl mx-auto"
              variants={itemVariants}
            >
              Contact us today to learn more about our biomass fuel solutions and get a customized quote.
            </motion.p>
